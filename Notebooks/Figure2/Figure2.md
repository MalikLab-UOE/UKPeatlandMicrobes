...
![](Figure2_files/figure-markdown_strict/Figure%202c-3.png)
    ...
    ## (Intercept)    -0.2032     0.4770  -0.426
    ## TreatmentDAM    0.7151     0.2774   2.578
    ## TreatmentREST   0.3058     0.2774   1.102
    ## 
    ...
    ## Warning in checkConv(attr(opt, "derivs"), opt$par, ctrl = control$checkConv, : unable to evaluate scaled
    ## gradient

    ## Warning in checkConv(attr(opt, "derivs"), opt$par, ctrl = control$checkConv, : Hessian is numerically
    ## singular: parameters are not uniquely determined
    ...
    ## Fixed effects:
    ##                               Estimate Std. Error t value
    ## (Intercept)                     0.9978     0.6643   1.502
    ## TreatmentDAM                    1.1643     0.7051   1.651
    ## TreatmentREST                   1.1193     0.7051   1.587
    ## SiteBowness                    -0.9277     0.9395  -0.987
    ## SiteStean                      -2.9750     0.9395  -3.167
    ## SiteMoors_House                -1.7758     0.9395  -1.890
    ## SiteLangwell                   -2.1494     0.9395  -2.288
    ## SiteCrocach                    -1.2320     0.9395  -1.311
    ## SiteMigneint                   -1.8567     0.9395  -1.976
    ## TreatmentDAM:SiteBowness        0.1939     0.9972   0.194
    ## TreatmentREST:SiteBowness      -1.3112     0.9972  -1.315
    ## TreatmentDAM:SiteStean          1.3560     0.9972   1.360
    ## TreatmentDAM:SiteMoors_House   -0.5541     0.9972  -0.556
    ## TreatmentREST:SiteMoors_House  -1.0020     0.9972  -1.005
    ## TreatmentDAM:SiteLangwell      -0.4773     0.9972  -0.479
    ## TreatmentREST:SiteLangwell     -0.1436     0.9972  -0.144
    ## TreatmentDAM:SiteCrocach       -1.1250     0.9972  -1.128
    ## TreatmentREST:SiteCrocach      -1.2677     0.9972  -1.271
    ## TreatmentDAM:SiteMigneint      -1.5000     0.9972  -1.504
    ## TreatmentREST:SiteMigneint     -0.9320     0.9972  -0.935
    ...
    ## Fixed effects:
    ##                   Estimate Std. Error t value
    ## (Intercept)        -0.0451     0.2602  -0.173
    ## degradation_index  -0.7268     0.2564  -2.834
    ## 
    ## Correlation of Fixed Effects:
    ##             (Intr)
    ## degrdtn_ndx 0.014
