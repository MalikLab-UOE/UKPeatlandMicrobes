...
```{r Microbial Growth Rate Across Treatments plot, fig.height=4, fig.width=4}
...
```{r save-MicrobialGrowthRate_Treatment}
...
```{r Microbial Growth Rate Across Sites plot, fig.height=5, fig.width=6}
...
```{r save-MicrobialGrowthRate_Sites}
...
```{r Methane scatter plot, fig.height=4.5, fig.width=6}
...
```{r save-MicrobialGrowthRate_Ecosytemhealth}
