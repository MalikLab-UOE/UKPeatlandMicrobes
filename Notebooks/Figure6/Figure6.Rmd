...
## Metabolic functions
```{r metabolic-results}
metabolic_modules <- read.csv("./METABOLIC_KEGG_module_presence.csv", fileEncoding = "UTF-8-BOM")
...
```{r merge-abundance-with-taxonomy-and-metabolism}
...
```{r merge-genome-abundance-get-with-metabolism}
...
```{r simple-genome-table-annotated}
...
fermentation_bar_plot <- ggplot(hmm_unique_hosts_by_category[hmm_unique_hosts_by_category$Category == "Fermentation",], 
  ...
  scale_fill_manual(values = c('NAT' = '#4daf4a', 'REST' = '#377eb8', 'DAM' = '#e41a1c'), labels = c('NAT' = 'Near-natural', 'REST' = 'Rewetted', 'DAM' = 'Restored')) +
